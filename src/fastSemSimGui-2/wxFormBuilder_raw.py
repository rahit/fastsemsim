...
class GO_load_gui ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.GO_load_source_label = wx.StaticText( self, wx.ID_ANY, u"No file selected. The built-in version will be loaded.", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.GO_load_source_label.Wrap( -1 )
		sbSizer3.Add( self.GO_load_source_label, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
