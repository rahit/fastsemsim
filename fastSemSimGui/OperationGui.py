...
#------------------------------------------------------------------------------------------------------------------
		...
		self.ss_advanced_cmd = wx.BitmapButton(self.panel, -1, wx.Bitmap(self.parentobj.Advanced_pic))
		...
		self.ms_advanced_cmd = wx.BitmapButton(self.panel, -1, wx.Bitmap(self.parentobj.Advanced_pic))
